            ...
            <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                        ...
                        <div class="noti-scroll" data-simplebar>
                            ...
                            <a href="javascript:void(0);"
                                ...
                                <div class="notify-icon">
                                    <img src=" {{ asset('admin/assets/images/users/user-12.jpg') }}"
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="#"
                        ...
                        <img src="{{ asset('admin/assets/images/users/user-11.jpg') }} " alt="user-image"
                    ...
                    <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <i class="mdi mdi-location-exit fs-16 align-middle ms-3"></i>
                                <span><button class="btn -btn-none">Logout</button></span>
                        </form>
