 <header class="header-v2">
                 ...
                 <div class="wrap-icon-header flex-w flex-r-m h-full">
                     ...
                     <div class="flex-c-m h-full p-l-18 p-r-25 bor5">
                         @php
                             ...
                             $totalProducts = $cart ? $cart->items()->count() : 0;
                         @endphp

                         <div class="icon-header-item cl2 hov-cl1 trans-04 p-lr-11 icon-header-noti js-show-cart"
                             data-notify="{{ $totalProducts }}">
     ...
     <div class="wrap-header-mobile">
         ...
         <div class="logo-mobile">
             <a href="{{ route('home') }}"><img src="{{ asset('client/assets/images/icons/logo-02.png') }}"
                     alt="IMG-LOGO"></a>
         </div>
                 ...
                 <div class="flex-w flex-sb p-t-36 gallery-lb">
                     ...
                     <div class="wrap-item-gallery m-b-10">
                         <a class="item-gallery bg-img1" href="{{ asset('client/assets/images/gallery-01.jpg') }} "
                             ...
                             style="background-image: url('{{ asset('client/assets/images/gallery-01.jpg') }}');"></a>
                     </div>
                     ...
                     <div class="wrap-item-gallery m-b-10">
                         <a class="item-gallery bg-img1" href=" {{ asset('client/assets/images/gallery-02.jpg') }}"
                             data-lightbox="gallery"
                             style="background-image: url(' {{ asset('client/assets/images/gallery-02.jpg') }}');"></a>
                     </div>
                     ...
                     <div class="wrap-item-gallery m-b-10">
                         <a class="item-gallery bg-img1" href="{{ asset('client/assets/images/gallery-03.jpg') }}"
                             data-lightbox="gallery"
                             style="background-image: url('{{ asset('client/assets/images/gallery-03.jpg') }}');"></a>
                     </div>
                     ...
                     <div class="wrap-item-gallery m-b-10">
                         <a class="item-gallery bg-img1" href="{{ asset('client/assets/images/gallery-04.jpg') }}"
                             data-lightbox="gallery"
                             style="background-image: url('{{ asset('client/assets/images/gallery-04.jpg') }}');"></a>
                     </div>
                     ...
                     <div class="wrap-item-gallery m-b-10">
                         <a class="item-gallery bg-img1" href="{{ asset('client/assets/images/gallery-05.jpg') }}"
                             data-lightbox="gallery"
                             style="background-image: url('{{ asset('client/assets/images/gallery-05.jpg') }}');"></a>
                     </div>
                     ...
                     <div class="wrap-item-gallery m-b-10">
                         <a class="item-gallery bg-img1" href="{{ asset('client/assets/images/gallery-06.jpg') }}"
                             data-lightbox="gallery"
                             style="background-image: url('{{ asset('client/assets/images/gallery-06.jpg') }}');"></a>
                     </div>
                     ...
                     <div class="wrap-item-gallery m-b-10">
                         <a class="item-gallery bg-img1" href="{{ asset('client/assets/images/gallery-07.jpg') }}"
                             data-lightbox="gallery"
                             style="background-image: url('{{ asset('client/assets/images/gallery-07.jpg') }}');"></a>
                     </div>
                     ...
                     <div class="wrap-item-gallery m-b-10">
                         <a class="item-gallery bg-img1" href="{{ asset('client/assets/images/gallery-08.jpg') }}"
                             data-lightbox="gallery"
                             style="background-image: url('{{ asset('client/assets/images/gallery-08.jpg') }}');"></a>
                     </div>
                     ...
                     <div class="wrap-item-gallery m-b-10">
                         <a class="item-gallery bg-img1" href="{{ asset('client/assets/images/gallery-09.jpg') }}"
                             data-lightbox="gallery"
                             style="background-image: url('{{ asset('client/assets/images/gallery-09.jpg') }}');"></a>
                     </div>
                 </div>
             </div>
